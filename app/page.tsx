  ...
  return (
    <main>
      ...
      <section className="wrap section autumn-available">
        <div className="section-heading winter-available-heading">
          <div><p className="section-kicker">S’OBRE EL CEL DE TARDOR</p><h2>Cinc portes connectades entre patrons, cúmuls i mites</h2></div>
        ...
        <div className="winter-available-list">
          ...
          <Link href="/constellacions/cefeu" className="winter-available-entry autumn-available-entry">
            <span>10</span><div><h3>Cefeu</h3><p>Una casa circumpolar guarda δ Cephei i la clau de les distàncies còsmiques.</p></div><b>Explora Cefeu →</b>
          </Link>
        </div>
      </section>
    </main>
